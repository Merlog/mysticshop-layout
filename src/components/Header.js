              ...
              <ul className="nav justify-content-end headerTop">
                ...
                <li className="nav-item dropdown">
                  ...
                  <div className="dropdown-menu">
                    <a className="nav-link active" href="#">Muj účet</a>
                    <a className="nav-link active" href="#">Moje Objednávky</a>
                    <a className="nav-link active" href="#">Bonus body</a>
                    <a className="nav-link active" href="#">Odhlasit</a>
                  </div>
                </li>
          ...
          <div className="row navMidle">
            ...
            <div className="col-6 my-3">
              <form className="form-inline my-2 my-lg-0">
                <input className="form-control mr-sm-2 customW400"  type="search" placeholder="Search"
                  aria-label="Search"/>
            ...
            <div className="col-2 pt30" >
              <a className="Kosik" href="#">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 48 48" className="cart-ico">
                  <path
          ...
          <div className="row">
            <div className="col col-lg-12">
              ...
              <ul className="nav nav-tabs headerBottom">
                ...
                <li className="nav-item">
                  <a className="nav-link" href="#">Bonusový program</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="#">Karetní hry</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="#">Věrnostní sleva ???</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="#">Jak nakupovat</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="#">Blog Mudrc</a>
                </li>
              </ul>
            </div>
          </div>
